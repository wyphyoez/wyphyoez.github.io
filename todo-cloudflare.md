...
## Header Scroll, Articles, and Icon Refinement

- [x] Audit Header scroll state, article routes/layout, and every visible icon treatment.
- [x] Make the Header transparent at scroll top and glass only after scrolling.
...
- [x] Push the Header/logo revision and redeploy Cloudflare Pages.
...
- [x] Audit current UI/UX, content hierarchy, SEO, accessibility, and performance.
- [x] Prioritize a high-impact improvement scope based on the audit.
- [x] Implement the selected visual, content, interaction, and technical upgrades.
- [x] Re-run local validation and verify the Cloudflare Pages deployment.
- [x] Push the upgraded site to GitHub and redeploy the final commit.

- [x] Audit all identity, title, author, social-link, README, and metadata references.
- [x] Inspect Cloudflare Pages projects and the available GitHub deployment connection.
- [x] Correct the project identity to Wai Yan Phyoe (@wyphyoez).
- [x] Run formatting, tests, and production build validation.
...
- [x] Fix the missing TinyLife project image in the deployed Projects card and verify the replacement asset loads locally and on wyphyoez.cyou.
